...
| Frontend | **134** | vitest unit tests (page-contract suites for the coverage matrix, footprint topology, campaign sorts, sample vault, agents fleet, IOC search, watchlist, findings triage, chart + triage components, browser-baseline check) + clean `tsc --noEmit` + Vite build |
